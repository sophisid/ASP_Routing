...
router.get('/getRoutes', async (req, res) => {
  // You had placeholders for retrieving relationships from DB. 
  // Provide your actual Cypher below:
  ...
  try {
    ...
    // You have a `simplifyRouteData()` in your code snippet. Use as needed.
    // ...
